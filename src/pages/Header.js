    ...
    <>
      <div className="relative mt-[64px] lg:mt-[96px]">
        ...
        <div className="absolute top-0 left-0 flex flex-col justify-center items-center text-center h-full px-8 md:px-[97px] lg:px-[165px] lg:translate-y-[-4rem]">
          <h1 className="text-[40px] md:text-[56px] lg:text-[56px] font-bold text-white mb-6 lg:w-[600px] lg:self-start lg:text-start">
            Scooter sharing made simple
          </h1>
          <p className="mb-9 text-white text-[15px] leading-[25px] lg:w-[405px] lg:text-start">
